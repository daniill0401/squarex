...
var Slider = /** @class */function () {
    ...
    Slider.prototype.listen = function () {
        ...
        this.arrows.on("click", function (e) {
            return _this.arrowClicked(e);
        });
        this.dots.on("click", function (e) {
            return _this.dotClicked(e);
        });
    };
    Slider.prototype.turn = function (to) {
        var _this = this;
        var active = $(this.slides[this.index]);
        var next = $(this.slides[to]);
        next.css("display", "none").addClass("active");
        active.fadeOut(300, function () {
            _this.dots.removeClass("active");
            $(_this.dots[to]).addClass("active");
            next.fadeIn();
            active.removeClass("active");
        });
        this.index = to;
    };
    Slider.prototype.dotClicked = function (e) {
        var t = e.currentTarget || e.delegateTarget;
        var next = parseInt($(t).attr("data-index"));
        this.turn(next);
    };
    Slider.prototype.arrowClicked = function (e) {
        var t = e.currentTarget || e.delegateTarget;
        var where = parseInt($(t).attr("data-where"));
        var l = this.length;
        var i = this.index;
        var next = where + i == l ? 0 : where + i < 0 ? l - 1 : where + i;
        s.turn(next);
    };
    return Slider;
}();
var Team = /** @class */function () {
    ...
    Team.prototype.listen = function () {
        var _this = this;
        this.arrows.on("click", function (e) {
            return _this.arrowClicked(e);
        });
        ...
        this.topics.on("click", function (e) {
            return _this.topicClicked(e);
        });
        this.topics[0].click();
    };
    Team.prototype.arrowClicked = function (e) {
        var t = e.currentTarget || e.delegateTarget;
        var where = parseInt($(t).attr("data-where"));
        var items = this.items.filter("[data-topic-index=" + this.topicIndex + "]");
        var l = items.length;
        var i = this.itemIndex;
        var next = where + i == l ? 0 : where + i < 0 ? l - 1 : where + i;
        this.turn(this.topicIndex, next);
    };
    Team.prototype.topicClicked = function (e) {
        var t = e.currentTarget || e.delegateTarget;
        var topicIndex = parseInt($(t).attr("data-topic-index"));
        this.turn(topicIndex, 0);
    };
    Team.prototype.dotClicked = function (e) {
        var t = e.currentTarget || e.delegateTarget;
        var itemIndex = parseInt($(t).attr("data-item-index"));
        this.turn(this.topicIndex, itemIndex);
    };
    Team.prototype.getPhoto = function (topicIndex, itemIndex) {
        return this.get(this.photos, topicIndex, itemIndex);
    };
    Team.prototype.getDots = function (topicIndex) {
        return this.dotsWrap.filter("[data-topic-index='" + topicIndex + "']");
    };
    Team.prototype.getDot = function (topicIndex, itemIndex) {
        return this.get(this.dots, topicIndex, itemIndex);
    };
    Team.prototype.getItem = function (topicIndex, itemIndex) {
        return this.get(this.items, topicIndex, itemIndex);
    };
    Team.prototype.get = function (from, topicIndex, itemIndex) {
        return from.filter("[data-topic-index='" + topicIndex + "'][data-item-index='" + itemIndex + "']");
    };
    Team.prototype.turn = function (topicIndex, itemIndex) {
        var _this = this;
        if (topicIndex != this.topicIndex || itemIndex != this.itemIndex) {
            // change item
            var oldItem = this.getItem(this.topicIndex, this.itemIndex);
            var newItem_1 = this.getItem(topicIndex, itemIndex);
            // change photo
            var oldPhoto = this.getPhoto(this.topicIndex, this.itemIndex);
            var newPhoto_1 = this.getPhoto(topicIndex, itemIndex);
            // change dot
            var oldDot_1 = this.getDot(this.topicIndex, this.itemIndex);
            var newDot_1 = this.getDot(topicIndex, itemIndex);
            newPhoto_1.css("display", "flex").hide(0);
            oldItem.add(oldPhoto).fadeOut(300, function () {
                newItem_1.add(newPhoto_1).fadeIn();
                oldDot_1.removeClass("active");
                newDot_1.addClass("active");
...
var Media = /** @class */function () {
    ...
    Media.prototype.paginate = function () {
    ...
    Media.prototype.turn = function (to) {
    ...
    Media.prototype.pageClicked = function (e) {
        var t = e.currentTarget || e.delegateTarget;
        var index = $(t).index();
        var pageIndex = index % 2;
        if (this.activeIndex != pageIndex) this.turn(pageIndex);
    };
    Media.prototype.arrowClicked = function (e) {
        var t = e.currentTarget || e.delegateTarget;
        var where = parseInt($(t).attr("data-where"));
        var l = this.posts.length % 2 + 1;
    ...
    Media.prototype.listen = function () {
        var _this = this;
        this.pages.delegate("span", "click", function (e) {
            _this.pageClicked(e);
        });
        this.arrows.on("click", function (e) {
            _this.arrowClicked(e);
        });
    };
    return Media;
}();
var join = {
    ...
    focus: function focus() {
        this.style.border = "";
        if (this.value.trim() == $(this).attr("data-value")) this.value = "";
    },
    blur: function blur() {
        if (this.value.trim() == "") this.value = $(this).attr("data-value");
    },
    verify: function verify() {
        var mailS = join.input.val().trim();
        if (mailS == join.input.attr("data-value")) return false;
    ...
    clicked: function clicked() {
        ...
        } else join.input.css("border", "1px solid red");
    },
...
var menu = {
    ...
    clicked: function clicked(e) {
        ...
        if (href[0] == "#") {
            ...
            if ($(".menu .cross").css("display") == "block") menu.hide();
            return false;
        }
        return true;
    },
